...
export default async function OnboardingPage() {
  ...
  return <main className="relative min-h-screen overflow-hidden bg-[#f5f8f9]"><div className="pointer-events-none absolute -left-36 top-16 h-[28rem] w-[28rem] rounded-full bg-[#168a9b]/15 blur-3xl" /><div className="pointer-events-none absolute -right-24 bottom-0 h-96 w-96 rounded-full bg-[#026a81]/10 blur-3xl" /><div className="pointer-events-none absolute inset-0 bg-[radial-gradient(#0e5e6f1a_1px,transparent_1px)] [background-size:22px_22px]" /><Progress value={10} className="relative rounded-none" /><div className="relative mx-auto max-w-4xl px-6 py-10"><Link href="/" className="mb-8 inline-flex items-center gap-2.5" aria-label="EduLink acasă"><span className="grid h-11 w-11 place-items-center overflow-hidden rounded-xl bg-[#e5f4f6]"><Image src="/edulink-logo-icon.png" alt="" width={64} height={64} className="h-9 w-9 object-contain" /></span><span className="bg-gradient-to-r from-[#003747] via-[#065465] to-[#026a81] bg-clip-text text-2xl font-extrabold tracking-tight text-transparent">EduLink</span></Link><section className="rounded-3xl border border-white bg-white/90 p-7 shadow-xl shadow-[#003747]/10 sm:p-10"><span className="inline-flex rounded-full bg-[#e5f4f6] px-3 py-1 text-xs font-bold text-[#0e5e6f]">BUN VENIT ÎN EDULINK</span><div className="mb-10 mt-5 space-y-2"><h1 className="text-2xl font-extrabold tracking-tight text-slate-950 sm:text-3xl">Alege rolul tău pe EduLink</h1><p className="max-w-2xl text-sm leading-6 text-slate-600">Rolul selectat determină funcționalitățile disponibile. Vei completa datele personale la pasul următor.</p></div><RoleSelectForm /></section></div></main>;
}
